...
# Copy channel.block to docker containers
...
docker cp mychannel.block peer0.org4.example.com:/opt/gopath/src/github.com/hyperledger/fabric/
...
docker exec -e "CORE_PEER_LOCALMSPID=Org4MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@org4.example.com/msp" peer0.org4.example.com peer channel join -b mychannel.block
